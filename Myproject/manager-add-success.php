 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tr bgcolor="EFEFEF">
                <td valign="top" style="font-family:verdana;font-size:13px;">Office Manager is Added Successfully . <a href="manager-list.php">Click Here</a> To View all Office List </td>
              </tr>
              <tr bgcolor="EFEFEF">
