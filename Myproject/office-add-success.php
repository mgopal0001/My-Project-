...
<body><header><img src="images/main.jpg" width=900 height=200>
</header>
<div class="content">
 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tr bgcolor="EFEFEF">
                <td valign="top" style="font-family:verdana;font-size:13px;">New Office is Added Successfully . <a href="offices-list.php">Click Here</a> To View all Office List </td>
              </tr>
              <tr bgcolor="EFEFEF">
